...
var IPayment = function () {
	...
	_createClass(IPayment, [{
		...
		key: 'makeACHPayment',
		value: function makeACHPayment(payloadJson) {
			throw new Error('payloadJson not yet implemented');
		}
	}, {
		key: 'payDirectWithSaveCardACH',
		value: function payDirectWithSaveCardACH(payloadJson) {
		...
		value: function fetchSingleOrder(payloadJson) {
			throw new Error('payloadJson not yet implemented');
		}
	}, {
		key: 'capturePayment',
		value: function capturePayment(payloadJson) {
			throw new Error('payloadJson not yet implemented');
		}
	}, {
		key: 'createPlan',
		...
		value: function webhookProcessor(req) {
